...
export const createJob = async (req, res) => {
    try {
        ...
        //handle arrays if sent a json string
...
export const getDashboardStats = async (req, res) => {
    try {
        ...
        const totalApplications = totalApplicationResults.length > 0 ? totalApplicationResults[0].count : 0;
...
//get all jobst posted by the admin
...
export const getJobsByAdmin = async (req, res) => {
    try {
        ...
        const countsMap = applicationState.reduce((acc, curr) => {
