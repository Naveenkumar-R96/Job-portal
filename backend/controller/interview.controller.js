...
import { parseQuestions, uploadFiles } from "../utils/helper.js";
import { handleError } from "../utils/helper.js";

import { replaceQuestions } from "../utils/helper.js";

//add to a company inteview question
...
export const addInterviewCompany = async (req, res) => {
    try {
        ...
        if (questionsData) {
            const formatted = parseQuestions(questionsData, "company", company._id, req.user._id);
...
//to get the questions of a company
...
export const addInterviewRole = async (req, res) => {
    try {
        ...
        if (questionsData) {
            const formatted = parseQuestions(questionsData, "role", role._id, req.user._id);
